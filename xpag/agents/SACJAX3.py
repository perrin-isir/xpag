...
class SACJAX(Agent, ABC):
    def __init__(
        ...
        def actor_loss(policy_params: Params, q_params: Params, alpha: jnp.ndarray,
                       observations, obs_actions, log_pi) -> jnp.ndarray:
            q_action = self.value_model.apply(q_params, observations, obs_actions)
        ...
        #     alpha = jnp.exp(alpha_params)
        #
        #     actor_loss, actor_grads = self.actor_grad(state.q_params,
        #                                               alpha,
        #                                               observations,
        #                                               obs_actions,
        #                                               log_pi)
