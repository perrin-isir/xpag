...
class SAC(OffPolicyActorCritic):
    ...
    def _loss_critic(
        ...
        **kwargs,
        ...
        next_action, next_log_pi = self._sample_action(
            params_actor, next_state, *args, **kwargs
        )
    ...
    def _loss_actor(
        ...
        **kwargs,
        ...
        return (
            jax.lax.stop_gradient(jnp.exp(log_alpha)) * mean_log_pi - mean_q,
            jax.lax.stop_gradient(mean_log_pi),
        )
